...
export default function Header({
  ...
  return (
    <div
      ref={navContainerRef}
      className="opacity-0 fixed inset-x-2 top-2 md:top-3 z-40 h-14 sm:h-16 border-none bg-[#FCFCFC] text-[#080807] font-DMregular transition-all duration-700 md:inset-x-6"
